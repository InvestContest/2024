...
- Зарегистрируйтесь: оставьте заявку [странице конкурса](https://meetup.tinkoff.ru/event/tinkoff-invest-robot-contest/) 25.02.2024, указав номер созданного счета. На почту придет письмо с подтверждением регистрации.
...
- Запустите робота в период с 25.02.2024 до 15.04.2024
